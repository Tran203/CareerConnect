 ...
 * @author ntokozo
 */
public class GetMentorshipRequestsServlet extends HttpServlet {
    @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //get data 
        List<Mentorship> mList = mfl.FindMentorshipUsingMentorEmail(email);
        List<Students> stdList = sfl.findAll();
        ...
        //request dispatcher
        RequestDispatcher disp = request.getRequestDispatcher("mentor_pages/notifications.jsp");
